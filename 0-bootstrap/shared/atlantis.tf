...
# module "sa_atlantis" {
#   source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric/modules/iam-service-account?ref=v41.1.0"
...
#   source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric/modules/secret-manager?ref=v41.1.0"
#   project_id = module.atlantis_project.project_id
#   secrets = {
#     tf-var-gh-token   = {}
#     gh-app-key        = {}
...
#
# module "atlantis_vpc" {
#   source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric/modules/net-vpc?ref=v41.1.0"
#   project_id = module.atlantis_project.project_id
#   name       = "atlantis-vpc"
#   subnets = [
#     {
...
#
# module "atlantis_nat" {
#   source         = "github.com/GoogleCloudPlatform/cloud-foundation-fabric/modules/net-cloudnat?ref=v41.1.0"
#   project_id     = module.atlantis_project.project_id
#   region         = var.default_region_2
...
#
# module "atlantis" {
#   source = "github.com/runatlantis/terraform-gce-atlantis?ref=4.1.0"
#
#   name       = "atlantis"
